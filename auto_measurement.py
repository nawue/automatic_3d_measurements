...
sys.path.append("/home/nawue/Desktop/Papers/Soco/bps/bps_demos/")
...
def save_data_csv(directory, perimetros, tiempos):
    ...
    csv_path = "/home/nawue/Desktop/Papers/Sarteco/experimentacion.csv"
    ...
    df.to_csv("/home/nawue/Desktop/Papers/Sarteco/experimentacion.csv")
...
@click.option(
    "--smpl_model",
    default="/home/nawue/Desktop/minimization/SMPL3/smpl_webuser/models/basicmodel_m_lbs_10_207_0_v1.0.0.pkl",
    help="SMPL Model",
    type=click.STRING,
)
@click.option(
...
@click.option(
    "--input_bps",
    default="/home/nawue/Desktop/Papers/Soco/multiway_registration_aligned.ply",
    help="BPS Input",
    type=click.STRING,
)
@click.option(
...
def main(
    ...
    start_time = datetime.now()
    body = o3d.io.read_point_cloud("/home/nawue/Desktop/Papers/Sarteco/nahuel/Model.ply")
    ...
    start_time = datetime.now()
    #body.export(input_bps)
    run_alignment.main("/home/nawue/Desktop/Papers/Sarteco/nahuel/Model.ply", output_bps)
    tiempos.append(datetime.now() - start_time)
    click.secho("Duration: {} \n".format(datetime.now() - start_time), fg="yellow")
